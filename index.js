...
*/
const BotName = '🤖Official GalaxyXD🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/wahyu.jr86'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/+6287784550689'; // Nomor whatsapplu cok
const kapanbotaktif = 'Jam 8 Pagi — 10 Malam '; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/Jaev96B0i2NGjqCjLHmuAP'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/Jaev96B0i2NGjqCjLHmuAP'; // OFFICIAL GRUP LU 2
const grupch3 = 'https://chat.whatsapp.com/Jaev96B0i2NGjqCjLHmuAP'; // OFFICIAL GRUP LU 3
//
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] WhatsApp bot GalaxyXD Ready Scan QR Now!`);
});
...
conn.sendMessage(id, 'Owner wa.me/+6287784550689' ,MessageType.text);
}
else if (text == '$creator'){
conn.sendMessage(id, 'Creator wa.me/+6287784550689' ,MessageType.text);
}
else if (text == 'GalaxyXD'){
conn.sendMessage(id, 'Aku BOT nya GalaxyXD' ,MessageType.text);
}
